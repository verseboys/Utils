package com.tool.utils.generateor.mybaits3; 
...
public class AutoCreateServiceAndActionformybatis  
{  
	private static final String BEAN_URL = "com.wellhome.emecloudservice.pojo";//model基础目录  
	// private static final String ACTION_URL = "com.change.func.action";//action基础目录  
	private static final String SERVICE_URL = "com.wellhome.emecloudservice.service";//service基础目录  
	private static final String SERVICEIMPL_URL = "com.wellhome.emecloudservice.service.impl";//service基础目录  
	private static final String MAPPER_URL = "com.wellhome.emecloudservice.dao";//service基础目录  
	private static final String CONTROLLER_URL = "com.wellhome.emecloudservice.controller";//controller基础目录  
	...
	{  
		...
		{  
			...
			sb.append("import " + SERVICE_URL + parentPack +".GenericDao;" + RT_2);
			...
			sb.append("public interface " + cName + "ServiceI "+"<T extends Serializable, PK extends Serializable> extends GenericDao <"+cName+",Long>");  
	...
	{  
		...
		{  
			...
			sb.append("import " + SERVICEIMPL_URL+"."+cName+"ServiceImpl;"+ RT_2);// 需要序列化 
			sb.append("import " + c.getName() + ";" + RT_1);// 导入实体类  
			//            sb.append("import " + BASE_SERVICE_URL + "." + BASE_SERVICE_NAME  
			//                    + ";");// 导入接口  
			sb.append(RT_2 + ANNOTATION); 
			...
			sb.append("     private "+cName+"ServiceImpl "+AutoCreateServiceAndActionformybatis.fixString(cName)+"ServiceImpl; "+ RT_2 ); 
	...
	{  
		...
		{  
			...
			sb.append("import " + "java.io.Serializable;"+ RT_2);// 需要序列化 
			sb.append("import " + "org.springframework.beans.factory.annotation.Autowired;"+ RT_2);// 需要序列化 
			sb.append("import " + MAPPER_URL+"."+cName+"Mapper;"+ RT_2);// 需要序列化 
			...
			sb.append("import " + SERVICE_URL + parentPack + "." + cName  
					+ "ServiceI;");// 导入接口  
			sb.append(RT_2 + ANNOTATION);  
			sb.append(RT_1 + "@Service"+"(\""+AutoCreateServiceAndActionformybatis.fixString(cName)+"ServiceImpl\")"+RT_1);  
			sb.append("public class " + cName + "ServiceImpl<T extends Serializable, PK extends Serializable> ");  
			//sb.append("extends " + IMPL_SERVICE_NAME + "<" + cName + "> ");  
			sb.append("implements " + cName + "ServiceI<T, PK>");  
			sb.append("{" + RT_2 );  
			sb.append("     @Autowired"+ RT_2 );  
			sb.append("     private "+cName+"Mapper "+AutoCreateServiceAndActionformybatis.fixString(cName)+"Mapper; "+ RT_2 ); 
